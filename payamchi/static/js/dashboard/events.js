 ...
 var dzChartlist = function(){
	...
	var polarAreaCharts = function(){
		var options = {
			...
			labels: ['خصوصی', 'عمومی', 'اختصاصی', 'اقتصادی'],
			fill: {
				opacity: 1,
		...
		if(jQuery('#chart_widget_2').length > 0 ){
			...
			new Chart(chart_widget_2, {
				...
				data: {
					...
					labels:  ['فروردین', 'اردیبهشت', 'خرداد','مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند', 'فروردین', 'اردیبهشت', 'خرداد'],
					datasets: [
						{
							label: "مجموعه داده",
	...
	var revenueChart = function(){
		if(jQuery('#revenueChart').length > 0 ){
			...
			new Chart(chart_widget_9, {
				type: "line",
				data: {
					labels:  ['مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند', 'فروردین', 'اردیبهشت', 'خرداد','مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند', 'فروردین', 'اردیبهشت', 'خرداد','مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند', 'فروردین', 'اردیبهشت', 'خرداد'],
					datasets: [{
						label: "آمارفروش",
