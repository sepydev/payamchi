...
if(jQuery('#chart_widget_1').length > 0 ){
    ...
    new Chart(chart_widget_1, {
        ...
        data: {
            ...
            labels:  ["آذر", "اسفند", "بهمن", "دی", "آذر", "آبان", "مهر"],
            datasets: [
                {
                    label: "مجموعه داده",
...
//#chart_widget_4
    ...
    let barChartData2 = {
        defaultFontFamily: 'Poppins',
        labels: ['یک', 'دو', 'سه', 'چهار', 'پنج', 'شش', 'هفت', 'هشت', 'نه', 'ده', 'یازده', 'دوزده', 'سیزده', 'چهارده', 'پانزده', 'شانزده', 'هفده', 'هجده', 'نوزده', 'بیست'],
        datasets: [{
            label: 'هزینه',
...
//#chart_widget_9
    ...
    new Chart(chart_widget_9, {
        type: "line",
        data: {
            labels:  ['مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند', 'فروردین', 'اردیبهشت', 'خرداد','مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند', 'فروردین', 'اردیبهشت', 'خرداد'],
            datasets: [{
                label: "آمار فروش",
